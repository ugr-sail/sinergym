...
Currently, we offer a **random controller** and a **rule-based controller** for both the *Datacenter* building and the *5Zone* building. See `controllers.py <https://github.com/ugr-sail/sinergym/blob/main/sinergym/utils/controllers.py>`__ for implementation details.
