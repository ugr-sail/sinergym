...
- **observation_space**: Definition of the observation space following the **gym standard**. 
...
This is because they are not variables recognizable by the simulator as such (Energyplus) 
