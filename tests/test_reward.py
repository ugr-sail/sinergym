...
def test_calculate(simple_reward,power,temperature,month,day,reward,reward_energy,reward_comfort):
	result=simple_reward.calculate(power,temperature,month,day)
